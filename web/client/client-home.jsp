...
<body>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value" id="lawyerConnections">0</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value" id="documents">0</div>
    ...
    <script>
        ...
        function loadStats() {
            fetch('../GetClientStatsServlet')
                ...
                .then(function(data) {
                    animateNumber('activeCases', 0, data.activeCases, 800);
                    animateNumber('lawyerConnections', 0, data.lawyerConnections, 800);
                    animateNumber('appointments', 0, data.appointments, 800);
                    animateNumber('documents', 0, data.documents, 800);
                })
