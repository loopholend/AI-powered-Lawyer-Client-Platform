...
<head>
    ...
    <style>
        ...
        .status { text-transform: uppercase; font-size: 0.7rem; font-weight: 700; border-radius: 20px; padding: 0.3rem 0.65rem; display: inline-block; align-self: start; }
            ...
            fetch('../GetCaseTimelineServlet?caseId=' + caseId)
                ...
                .then(function(items) {
                    ...
                    (items || []).forEach(function(t) {
                        ...
                        var dateStr = t.createdAt ? t.createdAt.substring(0, 16) : '';
                        html += '<div class="timeline-item"><strong>' + t.status.toUpperCase() + '</strong>' + note + ' <span style="color:#6b7280; font-size: 0.8rem;">(by ' + t.actor + ' on ' + dateStr + ')</span></div>';
                    });
                ...
                .then(function(items) {
                    ...
                    items.forEach(function(c, idx) {
                        ...
                        var complaintBtn = c.hasLawyer
                            ...
                            : '';
                        var statusClass = 'status-' + (c.status || 'pending').toLowerCase().replace(' ', '_');
                        html +=
                            '<div class="card">' +
                                '<div class="top">' +
                                    '<div>' +
