...
<body>
    ...
    <script>
        ...
        function searchLawyers() {
            ...
            fetch('../SearchLawyersServlet?' + params.toString())
                ...
                .then(function(data) {
                    ...
                    data.forEach(function(lawyer, index) {
                        var card = document.createElement('div');
                        card.className = 'lawyer-card';
                        
                        var initials = (lawyer.firstName ? lawyer.firstName.charAt(0) : '') + (lawyer.lastName ? lawyer.lastName.charAt(0) : '');
                        ...
                        card.innerHTML = 
                            ...
                            '<div class="lawyer-footer">' +
                                '<button class="btn-contact" onclick="showContactModal(' + index + ')">' +
        ...
        // Run immediately to ensure load even if event fired
        searchLawyers();
    </script>
</body>
</html>
