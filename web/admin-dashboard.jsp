    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a class="nav-item" onclick="loadPage('admin-verify-lawyers.jsp')">
                    <i class="fas fa-user-check"></i>
                    <span>Verify Lawyers</span>
                </a>
                <a class="nav-item" onclick="loadPage('admin-all-users.jsp')">
                    <i class="fas fa-users"></i>
                    <span>All Users</span>
                </a>
                <a class="nav-item" onclick="loadPage('admin-all-cases.jsp')">
