    ...
    <script>
        ...
        function displayCases(cases) {
            ...
            cases.forEach(function(c) {
                ...
                var initials = (c.clientFirstName ? c.clientFirstName.charAt(0) : '') + (c.clientLastName ? c.clientLastName.charAt(0) : '');
                var downloadBtn = c.documentPath ? 
                    '<button class="btn-timeline" onclick="downloadDocument(\'' + c.documentPath + '\')" style="background: #E5E7EB; color: #374151; margin-left: 0.5rem;"><i class="fas fa-download"></i> Doc</button>' : 
                    '';
                ...
                card.innerHTML =
                    ...
                    '<div style="margin: 1rem 0; padding: 1rem; background: #F9FAFB; border-radius: 8px; font-size: 0.9rem; color: #4b5563; border-left: 3px solid #E5E7EB; max-height: 150px; overflow-y: auto;">' +
                        '<strong>Case Description:</strong><br>' + c.description +
                    '</div>' +
