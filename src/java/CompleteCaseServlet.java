...
public class CompleteCaseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "UPDATE cases SET case_status = 'completed' WHERE case_id = ?";
            ...
            if (result > 0) {
                response.sendRedirect("client-upload-case.jsp?completed=true");
            } else {
